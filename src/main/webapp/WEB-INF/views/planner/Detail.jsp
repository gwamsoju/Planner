...
<body>
    ...
    <div  class="wrapper" >
        <div class="content" style="border: 1px solid gray">
            <form method="post" action="/planner/edit.do">
                <h3>메모 상세보기</h3>
                <label for="date">Date</label><br>
                <input type="text" id="date" name="date" value="${memoDetail.date}" readonly="readonly"><hr>
                ...
                <div class="w3-center">
                    ...
                    <input type="button" class="w3-red" value="일정 삭제" onclick="location.href='/planners/delete'"/>
